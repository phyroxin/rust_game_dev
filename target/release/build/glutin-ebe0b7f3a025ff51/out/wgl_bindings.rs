...
#[link_name="wglCreateLayerContext"]
            pub fn CreateLayerContext(hDc: types::HDC, level: __gl_imports::libc::c_int) -> types::HGLRC;
#[link_name="wglDeleteContext"]
            pub fn DeleteContext(oldContext: types::HGLRC) -> types::BOOL;
#[link_name="wglDescribeLayerPlane"]
            pub fn DescribeLayerPlane(hDc: types::HDC, pixelFormat: __gl_imports::libc::c_int, layerPlane: __gl_imports::libc::c_int, nBytes: types::UINT, plpd: *const types::LAYERPLANEDESCRIPTOR) -> types::BOOL;
...
#[link_name="wglGetLayerPaletteEntries"]
            pub fn GetLayerPaletteEntries(hdc: types::HDC, iLayerPlane: __gl_imports::libc::c_int, iStart: __gl_imports::libc::c_int, cEntries: __gl_imports::libc::c_int, pcr: *const types::COLORREF) -> __gl_imports::libc::c_int;
...
#[link_name="wglRealizeLayerPalette"]
            pub fn RealizeLayerPalette(hdc: types::HDC, iLayerPlane: __gl_imports::libc::c_int, bRealize: types::BOOL) -> types::BOOL;
#[link_name="wglSetLayerPaletteEntries"]
            pub fn SetLayerPaletteEntries(hdc: types::HDC, iLayerPlane: __gl_imports::libc::c_int, iStart: __gl_imports::libc::c_int, cEntries: __gl_imports::libc::c_int, pcr: *const types::COLORREF) -> __gl_imports::libc::c_int;
...
#[link_name="wglUseFontOutlines"]
            pub fn UseFontOutlines(hDC: types::HDC, first: types::DWORD, count: types::DWORD, listBase: types::DWORD, deviation: types::FLOAT, extrusion: types::FLOAT, format: __gl_imports::libc::c_int, lpgmf: types::LPGLYPHMETRICSFLOAT) -> types::BOOL;
#[link_name="wglUseFontOutlinesA"]
            pub fn UseFontOutlinesA(hDC: types::HDC, first: types::DWORD, count: types::DWORD, listBase: types::DWORD, deviation: types::FLOAT, extrusion: types::FLOAT, format: __gl_imports::libc::c_int, lpgmf: types::LPGLYPHMETRICSFLOAT) -> types::BOOL;
#[link_name="wglUseFontOutlinesW"]
            pub fn UseFontOutlinesW(hDC: types::HDC, first: types::DWORD, count: types::DWORD, listBase: types::DWORD, deviation: types::FLOAT, extrusion: types::FLOAT, format: __gl_imports::libc::c_int, lpgmf: types::LPGLYPHMETRICSFLOAT) -> types::BOOL;
}
